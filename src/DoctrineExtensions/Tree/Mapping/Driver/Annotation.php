...
namespace DoctrineExtensions\Tree\Mapping\Driver;

use DoctrineExtensions\Common\Mapping\Driver\AbstractAnnotation;
...
use DoctrineExtensions\Tree\Mapping\Validator;
 ...
 */
class Annotation extends AbstractAnnotation implements DriverInterface
{
    /**
     * Annotation to define the tree type
     */
    const TREE = 'DoctrineExtensions\\Tree\\Mapping\\Annotation\\Tree';

    /**
     * Annotation to mark field as one which will store left value
     */
    const LEFT = 'DoctrineExtensions\\Tree\\Mapping\\Annotation\\TreeLeft';

    /**
     * Annotation to mark field as one which will store right value
     */
    const RIGHT = 'DoctrineExtensions\\Tree\\Mapping\\Annotation\\TreeRight';

    /**
     * Annotation to mark relative parent field
     */
    const PARENT = 'DoctrineExtensions\\Tree\\Mapping\\Annotation\\ParentNode';

    /**
     * Annotation to mark node level
     */
    const LEVEL = 'DoctrineExtensions\\Tree\\Mapping\\Annotation\\TreeLevel';

    /**
     * Annotation to mark field as tree root
     */
    const ROOT = 'DoctrineExtensions\\Tree\\Mapping\\Annotation\\TreeRoot';

    /**
     * Annotation to specify closure tree class
     */
    const CLOSURE = 'DoctrineExtensions\\Tree\\Mapping\\Annotation\\TreeClosure';

    /**
     * Annotation to specify path class
     */
    const PATH = 'DoctrineExtensions\\Tree\\Mapping\\Annotation\\TreePath';

    /**
     * Annotation to specify path source class
     */
    const PATH_SOURCE = 'DoctrineExtensions\\Tree\\Mapping\\Annotation\\PathSource';

    /**
     * Annotation to specify path hash class
     */
    const PATH_HASH = 'DoctrineExtensions\\Tree\\Mapping\\Annotation\\PathHash';

    /**
     * Annotation to mark the field to be used to hold the lock time
     */
    const LOCK_TIME = 'DoctrineExtensions\\Tree\\Mapping\\Annotation\\TreeLockTime';
