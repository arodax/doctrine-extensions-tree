...
use DoctrineExtensions\Tree\Entity\MappedSuperclass\AbstractClosure;
...
class ClosureTreeRepository extends AbstractTreeRepository
{
    ...
    {
        return $this->listener->getStrategy($this->_em, $this->getClassMetadata()->name)->getName() === StrategyInterface::CLOSURE;
    }
