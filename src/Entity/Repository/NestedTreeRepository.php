...
use Arodax\Doctrine\Extensions\Tree\Strategy\ORM\Nested;
...
class NestedTreeRepository extends AbstractTreeRepository
{
    ...
    {
        return $this->listener->getStrategy($this->_em, $this->getClassMetadata()->name)->getName() === StrategyInterface::NESTED;
    }
